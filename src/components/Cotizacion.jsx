...
export default function Cotizacion() {
  ...
  return (
    <section id="cotizacion" className="relative overflow-hidden py-24 bg-gradient-to-br from-brand-blue/[0.05] via-white to-brand-mid/[0.05] shadow-[0_-6px_20px_-6px_rgba(0,0,0,0.08)]">
